          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              ...
              <thead>
                ...
                if($rolename=='PARENT')
                {
                  $query="select s.tblStudentId, concat(si.tblStudInfoLname, ', ', si.tblStudInfoFname, ' ', si.tblStudInfoMname) as studname, s.tblStudentType from tblstudent s, tblstudentinfo si, tblparentstudent ps where si.tblStudInfo_tblStudentId=s.tblStudentId and ps.tblParStud_tblParentId='$id' and s.tblStudentFlag=1 and s.tblStudentType='OFFICIAL'";
                  $result=mysqli_query($con, $query);
                }else{
                ...
                <td><form method="post" action="reportstatementofaccount.php"><input type="hidden" name="studentid" id="studentid" value="<?php echo $row['tblStudentId'] ?>"/><button type="submit" class="btn btn-success">View Statement of Account</button></form></td>
                </tr>
                <?php endwhile; ?>  
                  </tbody>
              </table>
